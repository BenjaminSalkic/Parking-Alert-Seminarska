  ...
  jQuery.fn.clock = function (options) {
    ...
    setInterval(function () {
      ...
      if (opts.type == "analog") {
        ...
        jQuery(_this)
          .find(".hour")
          .css({ "-moz-transform": hrotate, "-webkit-transform": hrotate });
      } else {
    ...
    setInterval(function () {
      ...
      if (opts.type == "analog") {
        ...
        jQuery(_this)
          .find(".min")
          .css({ "-moz-transform": mrotate, "-webkit-transform": mrotate });
      } else {
...
jQuery.calcTime = function () {
  ...
  var isDST =
    (d.getMonth() > 2 && d.getMonth() < 10) ||
    (d.getMonth() === 2 && d.getDate() >= 31 - ((d.getDay() + 1) % 7)) ||
    (d.getMonth() === 9 && d.getDate() < 31 - ((d.getDay() + 1) % 7));
